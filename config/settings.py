...
DATABASES = {
    'default': {
        ...
        'NAME': 'panda_experiments',                      # Or path to database file if using sqlite3.
        'USER': 'panda_experiments',                      # Not used with sqlite3.
...
SECRET_KEY = '!1_^^!vzqu7i39v%lgytktv_k*#65$7%c5l%)0kiai-@n(vci-'
...
# Caching
CACHE_MIDDLEWARE_KEY_PREFIX='panda_experiments'
