...
env.site_name = 'panda_experiments'

env.project_name = 'panda_experiments'
env.database_password = 'O7DBPyaGqN'
...
env.repository_url = "git@github.com:pandaproject/panda_experiments.git"
...
def production():
    ...
    env.site_domain = 'panda_experiments.panda.tribapps.com'    
...
def staging():
    ...
    env.site_domain = 'panda_experiments.panda.beta.tribapps.com'    
